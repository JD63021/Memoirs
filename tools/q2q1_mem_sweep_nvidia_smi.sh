...
APP="./build_dp_cuda_gmg/memoirs_test_structured_q2q1_stokes_pspg_mms_cuda"

OUTDIR="mem_sweep_q2q1_${SOLVER}_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$OUTDIR"
...
# Start moderate. Add 56/64 later if 48 is safe.
NS="${NS:-16 24 32 40 48}"
...
for N in $NS; do
  echo "============================================================"
  echo "Running Q2/Q1 memory sweep N=$N"
  echo "============================================================"
